      ...
      switch (ADCON0bits.CHS){
          ...
          case 0:
            if (cant == 1){
                ...
                ADCON0bits.CHS = cant;        //Cambiar a canal 1
            }
            break;
         case 1:
            if (cant == 2){
                ...
                ADCON0bits.CHS = cant;        //Cambiar a canal 2
            }
            break;
         case 2:
            if (cant == 3){
                ...
                ADCON0bits.CHS = cant;        //Cambiar a canal 3
            }
            break;
         case 3:
            if (cant == 4){
                ...
                ADCON0bits.CHS = cant;        //Cambiar a canal 4
            }
            break;
         case 4:
            if (cant == 5){
                ...
                ADCON0bits.CHS = cant;        //Cambiar a canal 5
            }
            break;
         case 5:
            if (cant == 6){
